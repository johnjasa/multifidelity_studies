...
# Run CCBlade
wt_opt_ccblade, analysis_options_ccblade, opt_options_ccblade = run_wisdem(fname_wt_input, fname_analysis_options_ccblade, fname_opt_options, fname_wt_output, folder_output)

# Run OpenFAST
wt_opt_openfast, analysis_options_openfast, opt_options_openfast = run_wisdem(fname_wt_input, fname_analysis_options_openfast, fname_opt_options, fname_wt_output, folder_output)
...
if rank == 0:
    ...
    print('Aerodynamic Cp OpenFAST   = ' + str(wt_opt_openfast['aeroelastic.Cp']))